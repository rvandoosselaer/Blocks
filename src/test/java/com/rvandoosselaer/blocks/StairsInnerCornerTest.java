 ...
 */
public class StairsInnerCornerTest {
    ...
    public void testDirection() {
        ...
        Block block = Block.builder()
                .name("my-block")
                .type("grass")
                .shape(ShapeIds.STAIRS_INNER_CORNER_WEST)
    ...
    public void testDoNotRenderSharedFace() {
        Block block = Block.builder()
                ...
                .shape(ShapeIds.STAIRS_INNER_CORNER_EAST)
                .usingMultipleImages(true)
                .build();
        ...
        // the shared face between the cube and the stairs should not exist. The stair shape should have 34 triangles.
        assertEquals(34, stairMesh.getTriangleCount());

        // when the cube is removed, the wedge should have all 36 triangles
