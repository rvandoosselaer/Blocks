...
//        physicsChunkPagerState = new PhysicsChunkPagerState(new PhysicsChunkPager(blocksManager));
//
//        stateManager.attachAll(blocksManagerState, physicsChunkPagerState, bulletAppState);
//
...
//        physicsChunkPagerState.setLocation(new Vector3f(cam.getLocation().x, 0, cam.getLocation().z));
//
//        if (bulletAppState.isInitialized() && physicsChunkPagerState.getPhysicsSpace() == null) {
//            PhysicsSpace physicsSpace = stateManager.getState(BulletAppState.class).getPhysicsSpace();
//            physicsChunkPagerState.setPhysicsSpace(physicsSpace);
