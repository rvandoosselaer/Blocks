...
//
///**
// * An application that pages endless terrain around the camera. The chunk generation and the mesh generation is done
// * on different worker threads.
// *
// * @author rvandoosselaer
// */
//public class EndlessTerrainMultiThreaded extends SimpleApplication {
//
...
//
//        EndlessTerrainMultiThreaded endlessTerrain = new EndlessTerrainMultiThreaded();
...
//                .chunkGenerationPoolSize(1) // 1 dedicated thread for chunk generation tasks
//                .meshGenerationPoolSize(1) // 1 dedicated thread for chunk mesh generation tasks
//                .build();
//
